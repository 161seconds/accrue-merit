        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 relative overflow-hidden">
            ...
            <div className="text-center mb-8 animate-[fadeIn_0.9s_ease]">
                ...
                <h1 className="font-display text-4xl sm:text-5xl font-bold leading-none text-parchment drop-shadow-[0_0_60px_rgba(201,168,76,0.25)]">
                    Tích Đức
                    <em className="text-gold-light not-italic block">Hành Thiện</em>
                </h1>
                <p className="mt-3 text-xs italic text-parchment/45 tracking-wider">
            ...
            <div className="flex flex-col gap-3 w-full max-w-[200px] animate-[fadeIn_0.9s_1.5s_both]">
                <button onClick={() => navigate('/karma')} className="btn-jade flex items-center justify-center gap-2">
                    🪷 Ghi đức
                </button>
                <button onClick={() => navigate('/karma')} className="btn-red flex items-center justify-center gap-2">
                    ⚡ Ghi tội
                </button>
            </div>
