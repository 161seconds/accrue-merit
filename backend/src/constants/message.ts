export const USERS_MESSAGES = {
  ...
  REFRESH_TOKEN_IS_INVALID: 'Access token is invalid',
  ...
  //
  CHANGE_PASSWORD_SUCCESS: 'Change password is successful',
  REFRESH_TOKEN_IS_SUCCESS: 'Refresh token is successful',
  //
  UPLOAD_IMAGE_SUCCESS: 'Upload image is successful',
  UPLOAD_VIDEO_SUCCESS: 'Upload video is successful'
} as const
